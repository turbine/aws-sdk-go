...
var renamedPackages = map[string]*packageRenames{
	...
	"github.com/turbine/aws-sdk-go/service/autoscaling/autoscalingiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/cloudformation/cloudformationiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/cloudhsm/cloudhsmiface": {
		operations: map[string]string{
			"CreateHAPG":          "CreateHapg",
			"CreateHAPGPages":     "CreateHapgPages",
			"CreateHAPGRequest":   "CreateHapgRequest",
	...
	"github.com/turbine/aws-sdk-go/service/cloudsearch/cloudsearchiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/cloudsearchdomain/cloudsearchdomainiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/cloudtrail/cloudtrailiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/cloudwatch/cloudwatchiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/cloudwatchlogs/cloudwatchlogsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/codecommit/codecommitiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/codedeploy/codedeployiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/configservice/configserviceiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/directconnect/directconnectiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/ec2/ec2iface": {
		operations: map[string]string{
			"AcceptVPCPeeringConnection":           "AcceptVpcPeeringConnection",
			"AcceptVPCPeeringConnectionPages":      "AcceptVpcPeeringConnectionPages",
			"AcceptVPCPeeringConnectionRequest":    "AcceptVpcPeeringConnectionRequest",
	...
	"github.com/turbine/aws-sdk-go/service/ecs/ecsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/efs/efsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/elasticache/elasticacheiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/elasticbeanstalk/elasticbeanstalkiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/glacier/glacieriface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/kms/kmsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/machinelearning/machinelearningiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/turbine/aws-sdk-go/service/mobileanalytics": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ID": "Id",
	...
	"github.com/turbine/aws-sdk-go/service/mobileanalytics/mobileanalyticsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/rds/rdsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/route53domains/route53domainsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/s3/s3iface": {
		operations: map[string]string{
			"DeleteBucketCORS":        "DeleteBucketCors",
			"DeleteBucketCORSPages":   "DeleteBucketCorsPages",
			"DeleteBucketCORSRequest": "DeleteBucketCorsRequest",
	...
	"github.com/turbine/aws-sdk-go/service/ses/sesiface": {
		operations: map[string]string{
			"GetIdentityDKIMAttributes":        "GetIdentityDkimAttributes",
			"GetIdentityDKIMAttributesPages":   "GetIdentityDkimAttributesPages",
			"GetIdentityDKIMAttributesRequest": "GetIdentityDkimAttributesRequest",
	...
	"github.com/turbine/aws-sdk-go/service/sqs/sqsiface": {
		operations: map[string]string{
			"GetQueueURL":        "GetQueueUrl",
			"GetQueueURLPages":   "GetQueueUrlPages",
			"GetQueueURLRequest": "GetQueueUrlRequest",
	...
	"github.com/turbine/aws-sdk-go/service/ssm/ssmiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/storagegateway/storagegatewayiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/sts/stsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/support/supportiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/swf/swfiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/turbine/aws-sdk-go/service/workspaces/workspacesiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
